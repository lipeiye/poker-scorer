...
**当前状态（2026-07-19）**：T01–T16、T20、T21、T23–T26 已落地；其中 T06 已由 T11 的权威预览确认流替代，T14 已补两人桌断线不独赢的精确覆盖。T17/T18/T19/T22 仍按卡片要求等待产品决策，未擅自实施。
...
| 2026-07-19 | **阶段 1 与无决策依赖卡片完成**：T02–T16、T20、T21、T23–T26；结算预览/退款语义、SSOT、确认链、CI、部署检查与回归测试已同步；并修复 alarm 清理后 close 回调复活存储的竞态 |
